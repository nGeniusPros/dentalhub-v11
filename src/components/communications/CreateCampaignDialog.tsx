...
export const CreateCampaignDialog: React.FC<CreateCampaignDialogProps> = ({
  ...
  const campaignTypes = [
    ...
    { id: 'reactivation', name: 'Reactivation', icon: 'RefreshCw', description: 'Re-engage inactive patients' },
    { id: 'treatment', name: 'Treatment', icon: 'Activity', description: 'Follow up on pending treatments' },
              ...
              {campaignTypes.map((type) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    {type.icon === 'RotateCcw' && <Icons.RotateCcw className={`w-5 h-5 ${campaignType === type.id ? 'text-primary' : 'text-gray-400'}`} />}
                    {type.icon === 'RefreshCw' && <Icons.RefreshCw className={`w-5 h-5 ${campaignType === type.id ? 'text-primary' : 'text-gray-400'}`} />}
                    {type.icon === 'Activity' && <Icons.Activity className={`w-5 h-5 ${campaignType === type.id ? 'text-primary' : 'text-gray-400'}`} />}
                    {type.icon === 'Calendar' && <Icons.Calendar className={`w-5 h-5 ${campaignType === type.id ? 'text-primary' : 'text-gray-400'}`} />}
                    {type.icon === 'Settings' && <Icons.Settings className={`w-5 h-5 ${campaignType === type.id ? 'text-primary' : 'text-gray-400'}`} />}
                    <div>

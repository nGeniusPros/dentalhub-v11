...
/**
 * Voice Campaign feature rules module - TEST VERSION
 * 
 * This is a modified version for testing that disables authentication requirements
 */
...
/**
 * Register all voice campaign feature rules with the rule engine - TEST VERSION
 * This version disables authentication for testing purposes
 *
...
export function registerVoiceCampaignRules(ruleEngine: RuleEngine, supabase: SupabaseClient): void {
  ...
  // TEST VERSION: Disabled authentication for testing
  // Original rule commented out below
  /*
